...
<div class="col-lg-12">
      ...
      <!-- 设置开始 -->
        <form method="post" action="{{url('/admin/config/doreport')}}" style='width:800px'class="form-horizontal">
        {{ csrf_field() }}
            <div class="form-group form-group-lg">
              <label class="col-sm-2 control-label"  for="content">添加举报类别</label>
              <div class="col-sm-10">
                    <input class="form-control" type="text" name="content" id="content" value="" placeholder="请输入内容" required >
              </div>
            </div><br>
