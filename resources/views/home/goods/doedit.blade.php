...
@section('content')
	...
	<body>
		<form method="post" action="{{url('goods/doedit')}}/{{$data['gid']}}" id="goods_form">
			{{csrf_field()}}
			...
			<div class="form-group">
				...
				<input type="text" name="gname" value="{{$data['gname']}}" class="form-control"  placeholder="名称" style="width:200px">
			</div>
			<div class="form-group">
				<label for="exampleInputPassword1">商品价格</label>
				<input type="text" name="gpic" value="{{$data['gpic']}}" class="form-control" placeholder="价格" style="width:200px">
			</div>
			<div class="form-group">
			    <label for="exampleInputFile">缩略图</label>
			    <input type="hidden" name="gsmallpic" id="gsmallpic" value="{{$data['gsmallpic']}}">
		  	...
		  	<div>
		  		<img src="/{{$data['gsmallpic']}}" alt="" name="pic" id="pic" style="width:100px;">
		  	</div>
			<div class="form-group">
